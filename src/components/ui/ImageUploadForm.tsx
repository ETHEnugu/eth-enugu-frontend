  ...
  return (
    ...
    >
      ...
      <div className="relative h-[335px] md:h-[640px] w-full">
        ...
        <label
          htmlFor="image"
          className="absolute bottom-3 right-5 md:right-14 w-[140px] h-[140px] md:w-[274px] md:h-[274px] bg-[#707070] rounded-full border-[5px] md:border-[10px] border-[var(--background)] overflow-hidden flex items-center justify-center"
        >
