export const confRolesOptions = [
  ...
  {
    label: "Web3 Enthusiast",
    value: "WEB_3_ENTHUSIAST",
  },
  {
  ...
  {
    label: "General Blockchain/Crypto Enthusiast",
    value: "GENERAL_BLOCKCHAIN_CRYPTO_ENTHUSIAST",
  },
  {
    label: "Content Creators & Content Writers",
    value: "CONTENT_CREATORS_AND_CONTENT_WRITERS",
  },
  {
    label: "UI/UX & Creative designers",
    value: "UI_UX_AND_CREATIVE_DESIGNERS",
  },
  {
    label: "Community/Social Media Manager",
    value: "COMMUNITY_SOCIAL_MEDIA_MANAGER",
  },
  {
